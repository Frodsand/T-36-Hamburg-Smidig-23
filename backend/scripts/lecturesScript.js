    ...
    try{
        const lecturesDocuments = [

            {
                ...
                learningOutcome: "I denne undervisningen skal elevene lære om Etter å ha fullført denne leksjonen om matlaging, vil elevene kunne: Identifisere grunnleggende matlagingsteknikker: Elevene vil kunne gjenkjenne og navngi grunnleggende matlagingsteknikker som kutting, skrelling, røring, knusing, blanding og steking.\n 2. Bruke trygge og hygieniske praksis på kjøkkenet: Elevene vil lære viktigheten av håndvask før matlaging, bruk av forkle og håndklær, og å holde arbeidsområdet rent og ryddig. De vil også forstå betydningen av matoppbevaring og bruk av ferske ingredienser.Utføre enkle oppskrifter: Elevene vil kunne lese og forstå enkle oppskrifter ved å følge Utføre enkle oppskrifter: Elevene vil kunne lese og forstå enkle oppskrifter ved å følge, trinnvis veiledning. De vil utvikle ferdigheter til å måle ingredienser riktig og bruke grunnleggende kjøkkenutstyr som kniver, skjærebrett og målekopper.\n4. Forstå sunne matvaner: Elevene vil bli introdusert for grunnleggende ernæringsprinsipper og oppmuntres til å velge sunne ingredienser og lage balanserte måltider. De vil lære om viktigheten av å inkludere frukt, grønnsaker og fiberrike matvarer i kostholdet sitt.",
            ...
            },
            {
                ...
                instructions: "1. Vask og skjær grønnsakene i strimler.\n 2. Varm tortillaene i en panne. 3.\n Legg grønnsakene på tortillaene og brett dem sammen. 4.\n Server og nyt!",
            ...
            },
            {
                ...
                instructions: "1. Lag fullkornsbunn ved å blande mel, gjær, olivenolje, salt og vann. La deigen heve.\n 2. Kjevle ut deigen og form små pizzaer. 3.\n Tilsett ønsket saus og fyll. 4.\n Stek i ovnen til osten er smeltet og bunnen er sprø. 5.\n Server og nyt!",
                ...
                "instructions": "1. Finn en skål eller en kopp.\n 2. Hell litt yoghurt i bunnen av beholderen. 3.\n Kutt opp ulike frukter som epler, bananer, og druer. 4.\n Legg fruktbitene over yoghurten. 5. Gjenta lagene med yoghurt og frukt til beholderen er full. 6.\n Topp det hele med litt honning eller granola for ekstra smak. 7.\n Nyt din fruktige yoghurtmiks!",
